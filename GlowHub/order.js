document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!productImage || !productName || !productPrice) {
        orderDetails.innerHTML = "<p style='font-family: \"Bahnschrift Light\", sans-serif; font-weight: bold; font-size: 48px; margin-top: 200px; margin-bottom: 100px; text-align: center;'>Няма направени поръчки.</p>";
